      ...
      >
        ...
        <S.ContainerForm>
          ...
          <select name='' id=''>
            <option hidden>
              {' '}
              O colaborador costuma apresentar iniciativa?
            </option>
          ...
          <select name='' id=''>
            <option hidden>
              {' '}
              Ele é organizado em suas atividades diárias?
            </option>
            <option value=''>Nunca</option>
            <option value=''>Raramente</option>
            <option value=''>Frequentemente</option>
          ...
          <select name='' id=''>
            <option hidden>
              {' '}
              Ele se adapta aos novos clientes e desafios?
            </option>
            <option value=''>Nunca</option>
            <option value=''>Raramente</option>
            <option value=''>Frequentemente</option>
          ...
          <select name='' id=''>
            <option hidden>
              {' '}
              Ele interage bem com seus colegas de equipe?{' '}
            </option>
            <option value=''>Nunca</option>
            <option value=''>Raramente</option>
            <option value=''>Frequentemente</option>
          ...
          <select name='' id=''>
            <option hidden>
              {' '}
              Tem a competência necessária para o que faz?
            </option>
            <option value=''>Nunca</option>
            <option value=''>Raramente</option>
            <option value=''>Frequentemente</option>
