...
export function Evaluation() {
  ...
  */
  ...
  const [selectedQuestionario, setSelectedQuestionario] = useState<iQuestoes[] | any>([])
  ...
  */
  ...
  function handleOpenEditModal(id: string, nome?: string, score?: iQuestoes) {
    id && setId(id)
    nome && setNome(nome)
    score && setSelectedScore(score)

    //@ts-ignore
    score && setFormato(score?.formato!)

    openModal(3)
  }


  function handleOpenSettingsModal(id: string, score?: any, nome?: string, selectedQuestionario?: iQuestoes) {
    ...
    setSelectedQuestionario(selectedQuestionario)
  ...
  */
  ...
  async function handleGetAndSetSettingsModal(id: string) {
    ...
    console.log(selectedQuestionario)
    handleOpenSettingsModal(selectedQuestionario.id, selectedQuestionario.questionarioScore[0], selectedQuestionario.nome, selectedQuestionario)
            ...
            questionario.map(
              (questioryItem: iQuestoes) => (
                ...
                <div className='box-avaliacoes' key={questioryItem.id}>
                  {/*
                    Now this one is the last step, cannot create 
        ...
        >
          ...
          {activeKey === 1 && (
            <>
              ...
              <div className="checkContainer">
                ...
                {/* Undone the filter
                  avaliacaoScoreKind == "questionarioDesempenho" && <CheckBox value="numerico"     checkBoxTitle='KPI / Númerico'     onChange={() => setFormato("numerico")}    checked={formato === "numerico"}      /> 
                */}
              ...
              <button className='send' type='submit'>Próximo</button>
          ...
          {activeKey === 2 && (
            <div className='confgContainer'>
              ...
              <div className="flexBtn">
                ...
                {/*
                Now the user cannot create a subitem Score!
              ...
              <S.ButtonsContainer>
                <button className='close' type='button'
                  onClick={() => handleOpenEditModal(selectedQuestionario.id, selectedQuestionario.nome, selectedQuestionario.questionarioScore[0],)}>
                  Voltar
                </button>
          ...
          {activeKey === 5 && (
            <>
              ...
              <S.ButtonsContainer>
                <button className='close' type='button' onClick={() => setActiveTabKey(2)} >
                  Voltar
                </button>
                <button className='send' type='submit'>
                  Atualizar
